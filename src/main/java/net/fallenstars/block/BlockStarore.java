...
public class BlockStarore extends ElementsFallenStars.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("starore"));
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemStarfragment.block, (int) (3+RANDOM.nextInt(6)+(fortune* RANDOM.nextInt(3)))));
		}
	}
}
