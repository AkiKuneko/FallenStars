...
package net.fallenstars.gui;

import net.fallenstars.ElementsFallenStars;
import net.fallenstars.FallenStars;
import net.fallenstars.procedure.ProcedureEclipceTableRecipes;
...
public class GuiEclipcetablegui extends ElementsFallenStars.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiEclipcetablegui(ElementsFallenStars instance) {
		super(instance, 33);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 35, 30) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 53, 30) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 125, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 71, 30) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				FallenStars.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Eclipce Table", 12, 10, -10066330);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 43, this.guiTop + 56, 90, 20, "Transfuse"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			FallenStars.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureEclipceTableRecipes.executeProcedure($_dependencies);
			}
		}
	}
