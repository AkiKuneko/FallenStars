...
import net.fallenstars.procedure.ProcedureSkytablerecipes;
...
public class GuiSkytablegui extends ElementsFallenStars.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiSkytablegui(ElementsFallenStars instance) {
		super(instance, 33);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 62, 30) {
			}));
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Skytable", 12, 10, -10066330);
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureSkytablerecipes.executeProcedure($_dependencies);
			}
		}
	}
