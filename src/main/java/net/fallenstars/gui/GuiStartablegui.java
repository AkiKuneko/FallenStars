...
public class GuiStartablegui extends ElementsFallenStars.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiStartablegui(ElementsFallenStars instance) {
		super(instance, 5);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 44, 35) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 116, 35) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 62, 35) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Star Table", 10, 12, -13421773);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 43, this.guiTop + 65, 90, 20, "Transfuse"));
		}
