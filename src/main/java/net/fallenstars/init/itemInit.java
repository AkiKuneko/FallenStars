...
public class itemInit
{
    ...
    public static final ArmorMaterial ARMOR_MOON = EnumHelper.addArmorMaterial("armor_moon", FallenStars.MODID + ":moon" ,2000, new int[]{8,15,14,10},19, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.0F);
