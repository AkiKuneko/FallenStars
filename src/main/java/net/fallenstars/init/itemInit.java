...
public class itemInit
{
    ...
    public static final ArmorMaterial ARMOR_SUN = EnumHelper.addArmorMaterial("armor_sun", FallenStars.MODID + ":sun" ,1000, new int[]{5,10,7,5},19, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.0F);
    public static final ArmorMaterial ARMOR_MOON = EnumHelper.addArmorMaterial("armor_moon", FallenStars.MODID + ":moon" ,1000, new int[]{8,15,14,10},19, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.5F);
