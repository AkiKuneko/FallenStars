...
public class ProcedureStarfragmentblockOnBlockRightClicked extends ElementsFallenStars.ModElement {
	public ProcedureStarfragmentblockOnBlockRightClicked(ElementsFallenStars instance) {
		super(instance, 36);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (world instanceof WorldServer)
				((WorldServer) world).spawnParticle(EnumParticleTypes.DRIP_LAVA, x, y, z, (int) 50, 1, 1, 1, 1, new int[0]);
					...
					SoundCategory.NEUTRAL, (float) 1, (float) 1);
			{
				...
				IBlockState _bs = BlockSunfragmentblock.block.getDefaultState();
