...
public class ProcedureSkytablerecipes extends ElementsFallenStars.ModElement {
	public ProcedureSkytablerecipes(ElementsFallenStars instance) {
		super(instance, 34);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Skytablerecipes!");
			return;
		}
		...
		if (((((new Object() {
			...
			if (entity instanceof EntityPlayerMP) {
				...
				if (_current instanceof Supplier) {
					Object invobj = ((Supplier) _current).get();
					if (invobj instanceof Map) {
						((Slot) ((Map) invobj).get((int) (3))).decrStackSize((int) (5));
